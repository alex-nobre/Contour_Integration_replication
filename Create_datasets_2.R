...
#                          direction = "long", 
#                          new.row.names = NULL)
rep_data_long <- reshape(rep_data, varying = 4:ncol(rep_data), sep = "_", 
                         direction = "long", 
                         new.row.names = NULL) #without trial level alpha data
...
rep_data5 <- cbind(rep_data4, threshold.sqr_1, threshold.sqr_2, threshold.rand_1, 
                   threshold.rand_2, threshold_1, threshold_2) #without dprime values
